...
export class AddWorkItemAssignmentNotifications1781200000000 implements MigrationInterface {
  name = 'AddWorkItemAssignmentNotifications1781200000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CHECK (notification_type IN ('work_item_comment_mention', 'work_item_assigned', 'workspace_invitation', 'workspace_member_removed'))
    `);
    ...
    await queryRunner.query(`
      ...
      CHECK (target_type IN ('work_item', 'work_item_comment', 'workspace_invitation', 'workspace'))
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      WHERE notification_type = 'work_item_assigned'
         OR target_type = 'work_item'
    `);
